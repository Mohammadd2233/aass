                        ...
                        <form>
                            <div class="row g-3">
                                <div class=" col-12 ">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='<%$ ConnectionStrings:Absent %>' SelectCommand="SELECT course_schedu.cr_Id, course_schedu.cr_name FROM course_schedu INNER JOIN st_cr ON course_schedu.cr_Id = st_cr.cr_id INNER JOIN student ON st_cr.st_id = student.st_Id WHERE (student.st_Id = @idd)">
                                        <SelectParameters>
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:Absent %>' SelectCommand="SELECT ex_Id, date, ex_type, doc, status FROM excute WHERE (cr_id = @cr) AND (st_id = @st)">
                                            <SelectParameters>
                                                ...
                                                <asp:SessionParameter SessionField="idd" Name="st"></asp:SessionParameter>
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                                        <br />
                                    </div>
